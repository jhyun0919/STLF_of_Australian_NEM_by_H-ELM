...
load_files_list = ['/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/load/NSW_nslp2006.csv',
                   '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/load/NSW_nslp2007.csv',
                   '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/load/NSW_nslp2008.csv',
                   '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/load/NSW_nslp2009.csv',
                   '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/load/NSW_nslp2010.csv',
                   '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/load/NSW_nslp2011.csv',
                   '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/load/NSW_nslp2012.csv',
                   '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/load/NSW_nslp2013.csv',
                   '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/load/NSW_nslp2014.csv',
                   '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/load/NSW_nslp2015.csv']

load_areas = ['ACTEWAGL', 'CITIPOWER', 'COUNTRYENERGY', 'ENERGYAUST', 'INTEGRAL', 'POWERCOR', 'TXU', 'UMPLP', 'UNITED',
              'VICAGL']

temperature_max_file = '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/weather/NSW_temp_max_2006_2015.csv'
temperature_min_file = '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/weather/NSW_temp_min_2006_2015.csv'
rainfall_file = '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/weather/NSW_rainfall_2006_2015.csv'
solar_expose_file = '/Users/JH/Documents/GitHub/PowerForecast/ver_06/data/weather/NSW_solar_2006_2015.csv'
...
class Preprocess:
    ...
    def normalization_load_data(data):
        ...
        numerator = data - min_arg
        denominator = max_arg - min_arg

        return (numerator / denominator), max_arg, min_arg
...
class Numpy2Pandas:
    ...
    @staticmethod
    def rmse_data2df(rmse_data):
        df = pd.DataFrame(rmse_data, columns=['RMSE'])
        return df

    @staticmethod
    def mape_data2df(rmse_data):
        df = pd.DataFrame(rmse_data, columns=['MAPE'])
        return df

    @staticmethod
    def mae_data2df(mae_data):
        df = pd.DataFrame(mae_data, columns=['MAE'])
        return df
