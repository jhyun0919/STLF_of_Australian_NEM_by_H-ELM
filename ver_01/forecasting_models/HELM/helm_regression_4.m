function [TrainingAccuracy,TestingAccuracy,Training_time,Testing_time] = helm_regression_4(train_x,train_y,test_x,test_y,b1,b2,b3,b4,b,s,C)
...
%TrainingAccuracy=mape(train_y',predict_y);
clear H;
...
%TestingAccuracy=mape(test_y',predict_yy);
