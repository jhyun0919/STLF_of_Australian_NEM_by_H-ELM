function [TrainingTime, TestingTime, TrainingAccuracy_RMSE, TestingAccuracy_RMSE] = elm_MultiOutputRegression(train_x, train_y, test_x, test_y, No_of_Output, NumberofHiddenNeurons, ActivationFunction)
...
%TrainingAccuracy_MAPE= mape(T, Y);
clear H;
...
%TestingAccuracy_MAPE = mape(TV.T, TY);
