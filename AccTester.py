...
pl_o = np.array([0.31445369, 0.26013332, 0.2690349, 0.2598849, 0.18246181, 0.11986089,
...
pl_p = np.array([0.53542956, 0.45387472, 0.34691755, 0.22470909, 0.13235949, 0.06645209,
...
def MAPE(forecasted_data_vector, original_data_vector):
    """
    ...
    :return:
    """
    nominator = abs(original_data_vector - forecasted_data_vector)
    denominator = abs(original_data_vector)
    coefficient = 1 / len(original_data_vector)

    return (1 / len(original_data_vector)) * sum(
        abs(original_data_vector - forecasted_data_vector) / abs(original_data_vector)) * 100


def MAE(forecasted_data_vector, original_data_vector):
    """
    Mean absolute error
    :param forecasted_data_vector:
    :param original_data_vector:
    :return:
    """
    return (1 / len(original_data_vector)) * sum(abs(original_data_vector - forecasted_data_vector))
