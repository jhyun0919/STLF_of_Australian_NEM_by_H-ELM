...
def run_graph(data_set):
    ...
    for step in range(num_steps):
        ...
        test_len = len(data_set.PreProcessed.Test.feature)
        batch_test_x = data_set.PreProcessed.Test.feature[:test_len].reshape((-1, n_steps, n_input))
        batch_test_y = data_set.PreProcessed.Test.target[:test_len]
