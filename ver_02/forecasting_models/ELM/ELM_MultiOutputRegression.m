function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = elm_MultiOutputRegression(train_x, train_y, test_x, test_y, No_of_Output, NumberofHiddenNeurons, ActivationFunction)
